...
public class ArraysUtility {
    // prints each integer of integer array in seperate lines
    ...
    // returns to frequency of the given element from the given array
    ...
    //removes index from the array, return new array
    ...
    // Merge the given two arrays and retunrs the new array
    ...
    // replace exact element from the array returns a new array with given new numbers
